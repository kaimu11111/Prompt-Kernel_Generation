...
__global__ void conv_relu_add_bias_unrolled_kernel(
    ...
    for (int c_in = 0; c_in < in_channels; c_in++) {
        ...
        dx = x_in_tile + 0;
        dy = y_in_tile + 1;
        input_idx = c_in * input_region_size + dx * input_region_height + dy;
        weight_idx = c_in * kernel_size_sq + 0 * kernel_size + 1;
        sum += input_shared[input_idx] * weight_shared[weight_idx];
        ...
        dy = y_in_tile + 2;
        input_idx = c_in * input_region_size + dx * input_region_height + dy;
        weight_idx = c_in * kernel_size_sq + 0 * kernel_size + 2;
        sum += input_shared[input_idx] * weight_shared[weight_idx];
        ...
        dy = y_in_tile + 0;
        input_idx = c_in * input_region_size + dx * input_region_height + dy;
        weight_idx = c_in * kernel_size_sq + 1 * kernel_size + 0;
        sum += input_shared[input_idx] * weight_shared[weight_idx];
        ...
        dy = y_in_tile + 1;
        input_idx = c_in * input_region_size + dx * input_region_height + dy;
        weight_idx = c_in * kernel_size_sq + 1 * kernel_size + 1;
        sum += input_shared[input_idx] * weight_shared[weight_idx];
        ...
        dy = y_in_tile + 2;
        input_idx = c_in * input_region_size + dx * input_region_height + dy;
        weight_idx = c_in * kernel_size_sq + 1 * kernel_size + 2;
        sum += input_shared[input_idx] * weight_shared[weight_idx];
        ...
        dy = y_in_tile + 0;
        input_idx = c_in * input_region_size + dx * input_region_height + dy;
        weight_idx = c_in * kernel_size_sq + 2 * kernel_size + 0;
        sum += input_shared[input_idx] * weight_shared[weight_idx];
        ...
        dy = y_in_tile + 1;
        input_idx = c_in * input_region_size + dx * input_region_height + dy;
        weight_idx = c_in * kernel_size_sq + 2 * kernel_size + 1;
        sum += input_shared[input_idx] * weight_shared[weight_idx];
        ...
        dy = y_in_tile + 2;
        input_idx = c_in * input_region_size + dx * input_region_height + dy;
        weight_idx = c_in * kernel_size_sq + 2 * kernel_size + 2;
        sum += input_shared[input_idx] * weight_shared[weight_idx];
    }
